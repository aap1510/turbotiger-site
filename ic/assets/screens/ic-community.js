(function (root) {
  ...
  IC.Screens.comunidade = function (deps) {
    ...
    function content() {
      ...
      var heading = initial ? "Base comunitária inicial" : "Agregação protegida";
      var explanation = initial ? "Registros reais, com análises exploratórias. Consulte a amostra e o período de cada resultado." : "Estatísticas agregadas, sem identificar os participantes.";
